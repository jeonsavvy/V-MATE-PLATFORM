export type CharacterFilter = "추천" | "신작 랭킹" | "남성 인기" | "여성 인기" | "2차 창작"
...
export const CHARACTER_FILTERS: CharacterFilter[] = ["추천", "신작 랭킹", "남성 인기", "여성 인기", "2차 창작"]
